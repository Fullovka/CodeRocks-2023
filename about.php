...
<head>
    ...
    <title>ExpertEase | О нашем проекте</title>
</head>
<body>
    ...
    <!-- О компании ExpertEase -->
    <section class="aboutCompany">
        <div class="container aboutCompany__row-container">
            <div class="aboutCompany__title">
                <h1 class="titleCompany">Что такое ExpertEase?</h1>
            </div>
            <div class="aboutCompany__subtitle">
                <p class="subtitleCompany">ExpertEase - это инновационный сервис, который поможет вам найти опытных профессионалов в различных областях, готовых оказать вам качественные услуги. Наша миссия - сделать процесс поиска и выбора специалиста максимально простым, удобным и эффективным.
                <br>
                Мы предлагаем удобный интерфейс для поиска, который позволяет быстро найти и связаться с теми, кто готов оказать вам услуги. Мы также гарантируем высокое качество предоставляемых услуг и уверены в профессионализме наших экспертов.
                <br>
                ExpertEase - это надежный партнер для тех, кто ищет лучших специалистов и желает получить высококачественный сервис. Наша компания создана, чтобы помогать людям достигать своих целей, а наши специалисты - чтобы помогать вам реализовывать ваши проекты и идеи.</p>
            </div>
            <!-- Фотография компании -->
            <div class="aboutCompany__img">
                <img src="./img/aboutCompany/aboutCompany.png" class="img" alt="Фотография компании">
            </div>
        </div>
    </section>
